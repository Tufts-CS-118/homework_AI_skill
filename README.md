...
AI should NEVER replace your learning, but AI could be an assistant. The idea is to use AI to generate questions to aid your thinking, NOT to answer questions for you. Please do not blindly trust any AI output. 

[SKILL.md](SKILL.md) is an example of prompts that can be uploaded to major AI chatbots.
Example usage: 
- Upload [SKILL.md](SKILL.md) and a homework question. 
